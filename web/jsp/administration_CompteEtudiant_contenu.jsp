...
<div id="compteEtudiant">
    <div id="modifEtudiant">
        <table>
            ...
            <html:form action="/Controller_Compte_Etudiant" enctype="multipart/form-data"> 
                <html:hidden property="var_choice_method" value="updatePoste" />
                <tr>
                    <td colspan="2">
                    <html:errors/>
                    </td>
    ...
    <div id="modifCV">
        <!--        <object type="application/pdf" name="PDF" id="PDF"> 
                <param value="C:/Users/thiam/Documents/NetBeansProjects/ProjetAlumni_git/web/img/cv_mbaye.thiam.pdf" />
                </object> -->
        <iframe src="<%=(String) session.getAttribute("cv")%>" width="500" height="700"  >
    </div>
</div>